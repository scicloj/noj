...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :id #uuid "de501b9c-a6a6-490c-a006-8b735a6bb29e",
...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :id #uuid "ca0d6cdb-fccd-49b5-911b-7de5fc1b9f22",
 :predictions #tech.v3.dataset.column&lt;float64&gt;[150]
:sepal-length
...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :explained #function[malli.core/-instrument/fn--54912],
 :R2 0.8586117200664085,
 :id #uuid "8ca473c6-9aa6-412f-8868-e75954c84ef5",
 :predictions #tech.v3.dataset.column&lt;float64&gt;[150]
:sepal-length
[5.015, 4.690, 4.749, 4.826, 5.080, 5.377, 4.895, 5.021, 4.625, 4.882, 5.216, 5.092, 4.746, 4.533, 5.199, 5.561, 5.094, 4.960, 5.368, 5.226...],
 :predict
...
{:name :sepal-length-prediction,
 ...
 {:feature-columns [:sepal-width :petal-length :petal-width],
  ...
  :explained #function[malli.core/-instrument/fn--54912],
  :R2 0.8586117200664085,
  :id #uuid "3467b354-b3ee-49e4-9d5f-6adccdf7e880",
  :options {:model-type :smile.regression/ordinary-least-square}}}
...
| :count |      :left |     :right |
|-------:|-----------:|-----------:|
|     22 | 0.00475971 | 0.20338248 |
|     17 | 0.20338248 | 0.40200525 |
|     22 | 0.40200525 | 0.60062802 |
|     21 | 0.60062802 | 0.79925079 |
|     17 | 0.79925079 | 0.99787356 |
