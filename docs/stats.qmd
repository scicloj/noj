...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :id #uuid "29b44631-e8e9-42f5-8a51-bc62f3b4e219",
...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :id #uuid "983d04aa-488d-4041-8dd9-d2fe4007596c",
 :predictions #tech.v3.dataset.column&lt;float64&gt;[150]
:sepal-length
...
{:feature-columns [:sepal-width :petal-length :petal-width],
 ...
 :explained #function[malli.core/-instrument/fn--54989],
 :R2 0.8586117200664085,
 :id #uuid "a7d9dbe3-41ae-48ef-96b8-57af02cae263",
 :predictions #tech.v3.dataset.column&lt;float64&gt;[150]
:sepal-length
[5.015, 4.690, 4.749, 4.826, 5.080, 5.377, 4.895, 5.021, 4.625, 4.882, 5.216, 5.092, 4.746, 4.533, 5.199, 5.561, 5.094, 4.960, 5.368, 5.226...],
 :predict
...
{:name :sepal-length-prediction,
 ...
 {:feature-columns [:sepal-width :petal-length :petal-width],
  ...
  :explained #function[malli.core/-instrument/fn--54989],
  :R2 0.8586117200664085,
  :id #uuid "1328cee4-e419-4d6b-a092-9a9f1a434f00",
  :options {:model-type :smile.regression/ordinary-least-square}}}
...
| :count |      :left |     :right |
|-------:|-----------:|-----------:|
|     18 | 0.00168062 | 0.20031103 |
|     21 | 0.20031103 | 0.39894143 |
|     14 | 0.39894143 | 0.59757183 |
|     16 | 0.59757183 | 0.79620224 |
|     30 | 0.79620224 | 0.99483264 |
